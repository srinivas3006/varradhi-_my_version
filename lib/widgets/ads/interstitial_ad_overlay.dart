...
Future<bool> showInterstitialAd(BuildContext context) async {
  ...
  final ads = await AdManager.instance.getAdsForZone('interstitial');
  final pool = ads.isNotEmpty
      ? ads
      : await AdManager.instance.getAdsForZone('feed');

  final ad = AdManager.instance.selectAd(pool);
  if (ad == null) {
    return false;
  }
...
class _InterstitialAdScreenState extends State<_InterstitialAdScreen> {
  ...
  void _handleClose() {
    ...
    AdManager.instance.recordDismiss(widget.ad, placementZone: 'interstitial');
  ...
  void _handleSkip() {
    _timer?.cancel();
    HapticFeedback.lightImpact();
    AdManager.instance.recordSkip(widget.ad, placementZone: 'interstitial');
    Navigator.of(context).pop();
  }

  Future<void> _handleTap() async {
    HapticFeedback.selectionClick();
    AdManager.instance.recordClick(widget.ad, placementZone: 'interstitial');
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          ClipRRect(
                            ...
                            child: CachedNetworkImage(
                              ...
                              errorWidget: (context, url, error) => Container(
                                ...
                                child: const Center(
                                  child: Icon(Icons.campaign_rounded, size: 72, color: Colors.white54),
                                ),
                              ),
                            ),
                          ),
                          ...
                          // Title
                          Text(
                            widget.ad.title.isNotEmpty ? widget.ad.title : 'Sponsored Promotion',
