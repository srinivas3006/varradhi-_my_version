...
class SponsoredSpotlightAdCard extends StatefulWidget {
  ...
  @override
  State<SponsoredSpotlightAdCard> createState() => _SponsoredSpotlightAdCardState();
}
...
class _SponsoredSpotlightAdCardState extends State<SponsoredSpotlightAdCard> {
  ...
  void _startCountdown() {
    _timer = Timer.periodic(const Duration(seconds: 1), (t) {
      ...
      if (_secondsRemaining <= 1) {
        ...
        AdManager.instance.recordSkip(widget.ad, placementZone: 'splash');
  ...
  void _handleClose({bool isManualDismiss = true}) {
    ...
    if (isManualDismiss) {
      AdManager.instance.recordDismiss(widget.ad, placementZone: 'splash');
    }
  ...
  Future<void> _handleAdTap() async {
    ...
    AdManager.instance.recordClick(widget.ad, placementZone: 'splash');
  ...
  Widget build(BuildContext context) {
    ...
    return AdViewabilityDetector(
      ...
      child: Container(
        ...
        color: Colors.black, // Opaque black prevents background news text overlap
        child: Stack(
          fit: StackFit.expand,
          children: [
            ...
            child: Center(
              child: CachedNetworkImage(
                ...
                errorWidget: (context, url, error) => Column(
                  ...
                  children: [
                    const Icon(Icons.campaign_rounded, size: 64, color: Colors.white54),
              ...
              child: BackdropFilter(
                ...
                child: Container(
                  ...
                  child: const Row(
                    ...
                    children: [
                      Icon(Icons.campaign_rounded, color: Colors.amber, size: 16),
                      SizedBox(width: 6),
                      Text(
                        'Sponsored',
                        style: TextStyle(
                  ...
                  child: Row(
                    ...
                    children: [
                      Padding(
                        ...
                        child: Text(
                          _secondsRemaining > 0 ? '${_secondsRemaining}s' : 'Done',
                          style: const TextStyle(
                            color: Colors.white,
                            fontSize: 12.5,
                            fontWeight: FontWeight.w800,
